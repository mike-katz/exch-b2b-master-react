    ...
    <div className="relative">
      ...
      <div className="grid grid-cols-12 gap-4 mt-2">
        ...
        <div className="col-span-2 flex items-center justify-end">
          <button className="common-button bg-[#FFFFFF] text-[#000000] rounded px-2 text-[12px] font-semibold flex items-center justify-center h-[31px] border border-[#cdcdcd]">
